...
# MAGIC %fs head /databricks-datasets/structured-streaming/events/file-10.json
...
# MAGIC %sql 
# MAGIC -- select * from static_counts where window.start = "2016-07-26T13:00:00.000+0000";
# MAGIC select * from static_counts limit 5;
